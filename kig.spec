...
%prep
%setup -q -n kig-20.12.0
cd %{_builddir}/kig-20.12.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1607718025
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/kig-20.12.0/COPYING %{buildroot}/usr/share/package-licenses/kig/8cf4afb0636055f7cacd1b6955e0e8ebec7888f5
cp %{_builddir}/kig-20.12.0/COPYING.DOC %{buildroot}/usr/share/package-licenses/kig/1bd373e4851a93027ba70064bd7dbdc6827147e1
cp %{_builddir}/kig-20.12.0/cmake/modules/COPYING-CMAKE-SCRIPTS %{buildroot}/usr/share/package-licenses/kig/ff3ed70db4739b3c6747c7f624fe2bad70802987
pushd clr-build
%make_install
popd
%find_lang kig
