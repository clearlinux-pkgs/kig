...
Source0  : https://download.kde.org/stable/release-service/21.08.3/src/kig-21.08.3.tar.xz
Source1  : https://download.kde.org/stable/release-service/21.08.3/src/kig-21.08.3.tar.xz.sig
...
%prep
%setup -q -n kig-21.08.3
cd %{_builddir}/kig-21.08.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1636068198
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/kig-21.08.3/LICENSES/BSD-3-Clause.txt %{buildroot}/usr/share/package-licenses/kig/f1946dab78e58c04c8c25ec6b074f5fc5c2830fe
cp %{_builddir}/kig-21.08.3/LICENSES/GFDL-1.2-or-later.txt %{buildroot}/usr/share/package-licenses/kig/ee03d68f6be20b170e5ea5d114d6acafb3f2d1dc
cp %{_builddir}/kig-21.08.3/LICENSES/GPL-2.0-only.txt %{buildroot}/usr/share/package-licenses/kig/3e8971c6c5f16674958913a94a36b1ea7a00ac46
cp %{_builddir}/kig-21.08.3/LICENSES/GPL-2.0-or-later.txt %{buildroot}/usr/share/package-licenses/kig/3e8971c6c5f16674958913a94a36b1ea7a00ac46
cp %{_builddir}/kig-21.08.3/LICENSES/GPL-3.0-only.txt %{buildroot}/usr/share/package-licenses/kig/2123756e0b1fc8243547235a33c0fcabfe3b9a51
cp %{_builddir}/kig-21.08.3/LICENSES/LGPL-2.1-or-later.txt %{buildroot}/usr/share/package-licenses/kig/81b58c89ceef8e9f8bd5d00a287edbd15f9d3567
cp %{_builddir}/kig-21.08.3/LICENSES/LicenseRef-KDE-Accepted-GPL.txt %{buildroot}/usr/share/package-licenses/kig/7d9831e05094ce723947d729c2a46a09d6e90275
cp %{_builddir}/kig-21.08.3/LICENSES/LicenseRef-KDE-Accepted-GPL.txt %{buildroot}/usr/share/package-licenses/kig/7d9831e05094ce723947d729c2a46a09d6e90275
pushd clr-build
%make_install
popd
