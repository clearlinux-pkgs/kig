...
Version  : 23.04.0
Release  : 58
URL      : https://download.kde.org/stable/release-service/23.04.0/src/kig-23.04.0.tar.xz
Source0  : https://download.kde.org/stable/release-service/23.04.0/src/kig-23.04.0.tar.xz
Source1  : https://download.kde.org/stable/release-service/23.04.0/src/kig-23.04.0.tar.xz.sig
...
%prep
%setup -q -n kig-23.04.0
cd %{_builddir}/kig-23.04.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1682091739
mkdir -p clr-build
pushd clr-build
